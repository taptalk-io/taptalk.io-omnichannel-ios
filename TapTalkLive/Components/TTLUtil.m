...
+ (UIColor *)randomPastelColor {
    ...
    UIColor *backgroundColor = [TTLUtil getColor:@"B6E6F0"];
    
    if (randomInteger == 1) {
        backgroundColor = [TTLUtil getColor:@"B6E6F0"];
    }
    else if (randomInteger == 2) {
        backgroundColor = [TTLUtil getColor:@"FDB2B9"];
    }
    else if (randomInteger == 3) {
        backgroundColor = [TTLUtil getColor:@"F49AB6"];
    }
    else if (randomInteger == 4) {
        backgroundColor = [TTLUtil getColor:@"D5C1E2"];
    }
    else if (randomInteger == 5) {
        backgroundColor = [TTLUtil getColor:@"FDD292"];
    }
    else if (randomInteger == 6) {
        backgroundColor = [TTLUtil getColor:@"FDC3A7"];
    }
    else if (randomInteger == 7) {
        backgroundColor = [TTLUtil getColor:@"D0E69D"];
    }
    else if (randomInteger == 8) {
        backgroundColor = [TTLUtil getColor:@"99D39E"];
    }
    else if (randomInteger == 9) {
        backgroundColor = [TTLUtil getColor:@"A9DDC7"];
    }
    else if (randomInteger == 10) {
        backgroundColor = [TTLUtil getColor:@"C6D3E9"];
    }
...
+ (NSString *)hardwareModel {
    NSString *hardware = [TTLUtil hardwareString];
...
+ (NSDictionary *)parameterFromURLString:(NSString *)urlString {
    ...
    for (NSString *parameterString in parameterSeparatedArray) {
        ...
        keyString = [TTLUtil nullToEmptyString:keyString];
        valueString = [TTLUtil nullToEmptyString:valueString];
...
+ (CGFloat)currentDeviceNavigationBarHeightWithStatusBar:(BOOL)statusBar iPhoneXLargeLayout:(BOOL)iPhoneXLargeLayout {
    ...
    NSInteger statusBarHeight = [TTLUtil currentDeviceStatusBarHeight];
...
+ (NSBundle *)currentBundle {
    NSBundle *resourceBundle = [PodAsset bundleForPod:@"TapTalkLive"];
